...
const LEGAL_DOC_ROUTE_MAP = {
  ...
  subscription: LEGAL_PATHS.subscriptionPolicy,
  'subscription-policy': LEGAL_PATHS.subscriptionPolicy,
  pricing: LEGAL_PATHS.pricingPolicy,
  'pricing-policy': LEGAL_PATHS.pricingPolicy,
