...
export const SEO_DEFAULTS = {
  ...
  themeColor: '#05204E',
  defaultDescription:
    'A Personal Digital Life Platform — organize personal records, expenses, reminders, festivals, documents, vehicles, trips, events, and everyday digital life tools in one secure app. Link Vault and Status Saver are free on Google Play.',
  defaultKeywords: [
    'BharatVow',
    'BharatVow app',
